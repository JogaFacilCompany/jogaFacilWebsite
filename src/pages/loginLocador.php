...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    $loginError = processLoginAttempt('locador', '../pages/dashboardLocador.php');
}
...
<main class="flex-grow-1 d-flex align-items-center justify-content-center py-5">
    <div class="loginFormCard card shadow-sm border-0 p-4" style="max-width: 440px; width: 100%;">
        ...
        <p class="text-center mt-1 small"><a href="../pages/loginLocatario.php" class="text-muted">Entrar como locatário</a></p>
    </div>
</main>
