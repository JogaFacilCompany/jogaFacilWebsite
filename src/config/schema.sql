...
INSERT INTO quadras (nome, endereco, imagem, locador_id, descricao, facilidades, telefone) VALUES
('Arena Gol de Placa', 'Rua do Ouro, 123 - Centro', 'https://images.unsplash.com/photo-1543351611-58f69d7c1781?auto=format&fit=crop&q=80&w=1000', 1, 'Excelente quadra de society para o seu rachão', '["Cantina", "Vestiários", "Aluguel de Bola", "Bebedouro"]', '(11) 99999-9999');
